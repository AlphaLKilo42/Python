import os
os.system('clear')
print("Python - Kidnapping Escape Game")
print("\nOne day, you are walking to a friend's house after school, it's a fairly \n" + "long walk there and you decide to sit down at a bench to rest for a few minutes.\n" + "Suddenly, an armored vehicle pulls up, and 2 armed men rush out, aiming at you \n" + "with disc loaded Nerf guns, and forcing you into the vehicle. You are knocked out\nvia chloroform soaked rag, and transported to a discreet location. You regain\nconciousness and find yourself in a chair, with your hands zip tied to the back of\nit. You are able to read the Braille lettering on the zipties. It reads:\n" + '"Made in China."' + " You are in a dimly lit, empty, concrete room. There is one door\nprotected by 2 armed guards, each with a grey, Fortnite SMG. There is also a man\nsitting calmly in a chair across from you. He looks to be in his mid to late 50's\nand wealthy judging by his suit and the singular ravioli that he was awkwardly\nfondling in his right hand. \n")
print('You need to escape the zip ties. You have 3 options.\n\n' + 'Option 1:\n' + 'Dislocate your thumb and attempt to slip out of the zip ties.\n\n' + 'Option 2:\n' + 'You have keys on your lanyard danglangling from your jeans, grab one and saw through\n' + 'the zip ties.\n\n' + 'Option 3:\n' + 'You also have a 4" pocket knife in your back pocket. Use it to slice through\n' + 'the ties.\n')
while True:
	try:
		choice1 = int(input("How will you free your hands? Enter the option number (1-3): "))
		if choice1 >= 1 and choice1 <= 3:
			if choice1 == 1:
				print("\nThe man notices you attempting to slip out of the ties. He gets up, bunny hops\n" + 'towards you, says "THIS IS SPARTA!", and proceeds to sparta kick you in the face.\nYou suffer a concussion, along with internal brain hemmoraging, and die.\n')
			elif choice1 == 2:
				print("\nThe man hears your keys danglangling as you attempt to grab one, stands up,\ndrops the ravioli, t-pose walks towards you, stops close to you, t-bags 3 times,\nsings 'Im a Little Teapot', grabs the dangle, takes another strangely moist ravioli\nfrom his backpocket, and suffocates you with it. As you begin to lose counsciousness,\nyou can hear the man, firmly grasping, fondling another moist ravioli while giggling.\n")
			elif choice1 == 3:
				...
				try:
					...
					if choice2a >= 1 and  choice2a <= 3:
						if choice2a == 1:
							print("\nThe guards shmack you across the room, you are dead on the spot.")
						elif choice2a == 2:
							...
							try:
								...
								if choice2b >= 1 and choice2b <= 2:
									if choice2b == 1:
										...
										print("\nAs you pull the man up, the guards take aim at you. Just as the guards squeeze\ntheir triggers, the man then speedily turns on you, choking you until he\nunknowingly, takes the bullets for you while he is attempting to strangle you.\nThe guards inadvertantly empty their clips into him (They take a while to process),\nthey reload, put another clip in him, reload. They reload a few more times, he still\n" + "doesn't die. They empty more rounds into him, he is still alive. Finally they unload\n50 more clips into him, and he gets knocked out from the impact of the bullet to his\nhead. Still not dead. You rush the door while they reload. They attempt to hault you\nby blocking the doorway. You kick the bigger guys legs out, retrieve your pocket\n" + "knife, and stab the other in the ribs. You have escaped. You run outside to find\nyou are in your friend's backyard. You can still hear the guards shooting the man,\nstill isn't dead...")
								else:
